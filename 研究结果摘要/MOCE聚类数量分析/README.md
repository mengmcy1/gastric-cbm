...
2. 相邻K之间ARI/NMI相对稳定；
3. 小患者簇和单患者主导簇不过多；
4. 重要概念及SSC/SDC结论不随K剧烈变化；
5. 医生能够为主要概念给出稳定、清晰的临床描述；
6. 多个K表现接近时，优先选择更小、更容易解释的K。
...
建议先比较K=20、25、30，并以K=35观察过度拆分；需要完整敏感性核查时再查看
K=10、15、40、45、50。不同K、模型和类别的概念编号不能直接对应。
